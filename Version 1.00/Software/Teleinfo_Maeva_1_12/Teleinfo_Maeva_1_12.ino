 ...
 * modification ecriture sur SD (utilisation de teleinfoFile.print à la place s'une variable STRING
 ...
 v1.12a * correction bug inversion colonnes HP et HC
 */
...
const char version_logiciel[7] = "V1.12a";
...
#ifndef option_Web    
    teleinfoFile.println(F("Date hh:mm,Heures Pleines,Heures Creuses,I ph1,I ph2,I ph3,P VA,Index Solaire,I A Solaire,P VA Solaire"));
#endif
  }
...
void fichier_annee()
{
  ...
  // date au format DATETIME de MySQL
   ...
   { 
      ...
      annetelefile.println(F("Date,Index HP,Index HC,Index PV"));
   }
